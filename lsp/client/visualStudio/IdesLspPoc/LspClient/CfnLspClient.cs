...
namespace IdesLspPoc.LspClient
{
    ...
    public class CfnLspClient : ILanguageClient
    {
        [Import]
        ...
        /// </summary>
        public string Name => "AWS Toolkit CFN language client for AWS Documents";
        ...
        private Process CreateLspProcess()
        {
            ...
            var dir = @"C:\code\aws-toolkit-common\lsp\app\aws-lsp-cloudformation-binary\bin";

            ProcessStartInfo info = new ProcessStartInfo
            {
                WorkingDirectory = dir,
                FileName = $@"{dir}\aws-lsp-cloudformation-binary.exe",
                Arguments = "--stdio",
